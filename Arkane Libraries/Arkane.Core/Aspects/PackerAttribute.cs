...
// Arkane.Core - PackerAttribute.cs
// 
// Alistair J. R. Young
// Arkane Systems
// 
...
namespace ArkaneSystems.Arkane.Aspects
{
    ...
    [PublicAPI]
    [RequirePostSharp ("Arkane.Aspects.Weaver", "PackerTask")]
    public class PackerAttribute : Attribute
    {
        ...
        /// </summary>
        public bool OptOut => (this.IncludeAssemblies == null) || (this.IncludeAssemblies.Length == 0) ;
