...
// Arkane.Aspects.Weaver - MethodBodyCreator.cs
// 
// Alistair J. R. Young
// Arkane Systems
// 
...
{
    internal static class MethodBodyCreator
    {
        /// <summary>
        ///     Creates a new method body and assigns it to <paramref name="hostMethod" />. The method body looks as described in
        ///     <see cref="CreatedEmptyMethod" />.
        /// </summary>
        ...
        public static CreatedEmptyMethod CreateModifiableMethodBody (InstructionWriter    instructionWriter,
                                                                     MethodDefDeclaration hostMethod)
        {
            // Create a new method body to host the pipeline.
            hostMethod.MethodBody = new MethodBodyDeclaration () ;
            InstructionBlock rootInstructionBlock =
                hostMethod.MethodBody.RootInstructionBlock = hostMethod.MethodBody.CreateInstructionBlock () ;
            ...
            if (!hostMethod.ReturnParameter.ParameterType.IsIntrinsic (IntrinsicType.Void))
            {
                ...
                returnVariable = rootInstructionBlock.DefineLocalVariable (
                                                                           ...
                                                                           DebuggerSpecialNames
                                                                              .GetVariableSpecialName (hostMethod.Domain,
                                                                                                       "returnValue",
